...
{
    internal class CustomStylizedLitShader : BaseShaderGUI
    {
        // Properties
        private CustomStylizedLitGUI.LitProperties litProperties;
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litProperties = new CustomStylizedLitGUI.LitProperties(properties);
        }
        ...
        public override void ValidateMaterial(Material material)
        {
            ...
            SetMaterialKeywords(material, CustomStylizedLitGUI.SetMaterialKeywords);
        }
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            {
                DoPopup(CustomStylizedLitGUI.Styles.workflowModeText, litProperties.workflowMode, Enum.GetNames(typeof(CustomStylizedLitGUI.WorkflowMode)));
            }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            CustomStylizedLitGUI.Inputs(litProperties, materialEditor, material);
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            ...
            {
                EditorGUI.BeginChangeCheck();
                materialEditor.ShaderProperty(litProperties.highlights, CustomStylizedLitGUI.Styles.highlightsText);
                materialEditor.ShaderProperty(litProperties.reflections, CustomStylizedLitGUI.Styles.reflectionsText);
                if (EditorGUI.EndChangeCheck())
                {
        ...
        public override void AssignNewShaderToMaterial(Material material, Shader oldShader, Shader newShader)
        {
            ...
            {
                material.SetFloat("_WorkflowMode", (float)CustomStylizedLitGUI.WorkflowMode.Specular);
            ...
            {
                material.SetFloat("_WorkflowMode", (float)CustomStylizedLitGUI.WorkflowMode.Metallic);
